...
county_record = GROUP nyc_record BY Plate_Type;
plate_output_record = FOREACH county_record GENERATE group, COUNT(nyc_record.Plate_Type);

store plate_output_record into 'gs://pda-org-data/PIG/output2' using PigStorage(',','-schema');
